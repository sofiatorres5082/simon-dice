  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Contenido */}
        <h2 className="font-bubblegum text-[#d3597c] text-center text-sm sm:text-3xl rounded-full py-1 max-w-[80%] sm:max-w-[80%] mx-auto tracking-wider select-none">
          UPS! te equivocaste
        </h2>
        <p className="text-center mt-4 text-lg text-[#df6c8d] font-pedagogique">
          Tu puntuación:{" "}
